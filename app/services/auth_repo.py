...
OTP_TABLE = (
    f"{SCHEMA}.HIQ_VENDOROTP"
)

LOGIN_LOG_TABLE = (
    f"{SCHEMA}.HIQ_VENDORLOGINLOG"
)

REFRESH_TOKEN_TABLE = (
    f"{SCHEMA}.HIQ_VENDORREFRESHTOKEN"
)
...
# ============================================================
# GET USER BY VENDOR ACCOUNT
# ============================================================
def get_user_by_vendor_account(
    vendor_account: str
):

    return get_portal_user(
        vendor_account
    )
